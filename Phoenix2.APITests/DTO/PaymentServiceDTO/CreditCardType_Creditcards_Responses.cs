...
{
    public class CreditCardType_Creditcards_Responses
    { 
        ...
        [JsonProperty("payeezyTransArmorToken", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string PayeezyTransArmorToken { get; set; }
        [JsonProperty("payeezyCorrelationId", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
