...
{
    public class AssignedTeam_PostRoleAssignment_Request
    {
    ...
    public class AssignedTeamType_PostRoleAssignment_Request
    {
    ...
    public class AssignedUser_PostRoleAssignment_Request
    {
    ...
    public class DripFeederType_PostRoleAssignment_Request
    { 
        ...
        public List<AssignedUser_PostRoleAssignment_Request> AssignedUsers { get; set; }
        [JsonProperty("assignedTeamTypes", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public List<AssignedTeamType_PostRoleAssignment_Request> AssignedTeamTypes { get; set; }
        [JsonProperty("assignedTeams", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public List<AssignedTeam_PostRoleAssignment_Request> AssignedTeams { get; set; }
