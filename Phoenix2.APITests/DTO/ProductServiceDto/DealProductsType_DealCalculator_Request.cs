...
{
    public class DealCalculatorLeadProduct_DealCalculator_Request
    {
        ...
        public Plan_DealCalculator_Request Plan { get; set; }
        [JsonProperty("rate", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public Rate_DealCalculator_Request Rate { get; set; }
        [JsonProperty("deductible", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public Deductible_DealCalculator_Request Deductible { get; set; }
        [JsonProperty("options", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public List<Option_DealCalculator_Request> Options { get; set; }
        [JsonProperty("dealCalculatorLeadProductId", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string DealCalculatorLeadProductId { get; set; }
        [JsonProperty("lenderCode", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string LenderCode { get; set; }
    }

    public class Deductible_DealCalculator_Request
    {
    ...
    public class Option_DealCalculator_Request
    {
        [JsonProperty("id", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string Id { get; set; }
        [JsonProperty("name", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
    ...
    public class Plan_DealCalculator_Request
    {
    ...
    public class Rate_DealCalculator_Request
    {
    ...
    public class DealProductsType_DealCalculator_Request
    { 
        [JsonProperty("lenderCode", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string LenderCode { get; set; }
        [JsonProperty("dealCalculatorLeadProductDtos", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public List<DealCalculatorLeadProduct_DealCalculator_Request> DealCalculatorLeadProductDtos { get; set; }
    }
}
