...
{
    public class GeneralInfoNew_LendersGeneral_Request
    {
    ...
    public class OpenLendingConfiguration_LendersGeneral_Request
    {
        [JsonProperty("userName", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string UserName { get; set; }
        [JsonProperty("password", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string Password { get; set; }
        [JsonProperty("institutionId", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string InstitutionId { get; set; }
    }

    public class LenderType_LendersGeneral_Request
    { 
        ...
        [JsonProperty("openLendingConfiguration", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public OpenLendingConfiguration_LendersGeneral_Request OpenLendingConfiguration { get; set; }
        [JsonProperty("generalInfo", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public GeneralInfoNew_LendersGeneral_Request GeneralInfo { get; set; }
    }
}
