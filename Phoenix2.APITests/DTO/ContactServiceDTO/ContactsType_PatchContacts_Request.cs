...
{
    public class Address_PatchContacts_Request
    {
    ...
    public class Asset_PatchContacts_Request
    {
    ...
    public class Employment_PatchContacts_Request
    {
    ...
    public class OtherIncome_PatchContacts_Request
    {
    ...
    public class Reference_PatchContacts_Request
    {
    ...
    public class ContactsType_PatchContacts_Request
    { 
