...
{
    public class DealFeeItem_DealType_PutDeals_Request
    {
    ...
    public class FinanceConditionItem_DealType_PutDeals_Request
    {
        ...
        public List<DealFeeItem_DealType_PutDeals_Request> DealFeeItems { get; set; }
    ...
    public class DealType_PutDeals_Request
    { 
        ...
        public FinanceConditionItem_DealType_PutDeals_Request FinanceConditionItemResponse { get; set; }
